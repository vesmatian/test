...
-- Busca la función Components.WindowPage y reemplázala con esta versión:
Components.WindowPage = function(self, Data)
    ...
    local Items = { } do
        ...
        -- NUEVO: Icono de la página (si se proporciona)
        if Data.Icon then
            ...
            -- Ajustar posición del texto si hay icono
    ...
    function Page:Turn(Bool)
        ...
        if Page.Active then
            ...
            if Items["Icon"] then
                ...
                Items["Text"]:Tween(nil, {Position = UDim2New(0, 35, 0.5, 0)})
            else
            ...
            if Items["Icon"] then
                ...
                Items["Text"]:Tween(nil, {Position = UDim2New(0, 30, 0.5, 0)})
            else
...
-- Busca la función Components.WindowSubPage y reemplázala con esta versión:
Components.WindowSubPage = function(self, Data)
    ...
    local Items = { } do
        ...
        -- NUEVO: Icono de la subpágina (si se proporciona)
        if Data.Icon then
            Items["Icon"] = Instances:Create("ImageLabel", {
                Parent = Items["Inactive"].Instance,
                Name = "\0",
        ...
        Instances:Create("UIPadding", {
            ...
            PaddingLeft = UDimNew(0, Data.Icon and 12 or 8)
        })
    ...
    function SubPage:Turn(Bool)
        ...
        if SubPage.Active then
            ...
            if Items["Icon"] then
                Items["Icon"]:ChangeItemTheme({ImageColor3 = "Accent"})
                Items["Icon"]:Tween(nil, {ImageColor3 = Library.Theme.Accent})
                Items["Text"]:Tween(nil, {Position = UDim2New(0.5, 10, 0.5, 0)})
            else
    ...
    Slider.AddSettingsMenu = function(self, config)
        return Library.AddSettingsMenuToElement(self, config)
    end
            return Slider, Items
        end
   ...
   Dropdown.AddSettingsMenu = function(self, config)
        return Library.AddSettingsMenuToElement(self, config)
    end
...
Library.Pages.SubPage = function(self, Data)
    ...
    NewButton.AddSettingsMenu = function(self, config)
        return Library.AddSettingsMenuToElement(self, config)
    end
        return NewButton
    end
    ...
    NewSearchbox.AddSettingsMenu = function(self, config)
        return Library.AddSettingsMenuToElement(self, config)
    end
        return NewSearchbox 
    end
...
-- ============================================================================
    -- EXTENSIÓN: SETTINGS MENU (Menú de configuración con ícono de tuerca)
    -- ============================================================================
    
    Library.SettingsMenus = {}
    Library.CurrentOpenSettingsMenu = nil
    
    -- Función para crear el ícono de tuerca
    local function CreateSettingsIcon(parent)
        local IconButton = Instances:Create("TextButton", {
            Name = "SettingsIcon",
            Parent = parent,
            Size = UDim2New(0, 14, 0, 14),
            Position = UDim2New(1, -18, 0.5, -7),
        ...
        IconButton:AddToTheme({BackgroundColor3 = "Inline", BorderColor3 = "Border"})
        ...
        IconImage:AddToTheme({ImageColor3 = "Text"})
        
        -- Hover effect
        IconButton.MouseEnter:Connect(function()
            Instances:Tween(IconButton, {BackgroundColor3 = Library.Theme["Hovered Element"]})
            Instances:Tween(IconImage, {Rotation = 90}, 0.3)
        end)
        
        IconButton.MouseLeave:Connect(function()
            Instances:Tween(IconButton, {BackgroundColor3 = Library.Theme["Inline"]})
            Instances:Tween(IconImage, {Rotation = 0}, 0.3)
        end)
        
        return IconButton
    end
    
    -- Función para crear el menú de configuración
    local function CreateSettingsMenu(items, originButton)
        local MenuFrame = Instances:Create("Frame", {
            Name = "SettingsMenu",
            Parent = Library.Holder,
        ...
        MenuFrame:AddToTheme({BackgroundColor3 = "Background", BorderColor3 = "Border"})
        ...
        for i, item in ipairs(items) do
            if item.Type == "Toggle" then
                ...
                ToggleFrame:AddToTheme({BackgroundColor3 = "Inline", BorderColor3 = "Border"})
                
                Instances:Create("UICorner", {Parent = ToggleFrame, CornerRadius = UDimNew(0, 3)})
                ...
                ToggleLabel:TextBorder()
                
                local ToggleBox = Instances:Create("Frame", {
                    Parent = ToggleFrame,
                    Size = UDim2New(0, 12, 0, 12),
                    Position = UDim2New(1, -16, 0.5, -6),
                    BackgroundColor3 = Library.Theme["Inline"],
                ...
                ToggleBox:AddToTheme({BackgroundColor3 = "Inline", BorderColor3 = "Outline"})
                
                Instances:Create("UICorner", {Parent = ToggleBox, CornerRadius = UDimNew(0, 2)})
                ...
                local Checkmark = Instances:Create("ImageLabel", {
                    ...
                    ImageTransparency = item.Default and 0 or 1,
                    ZIndex = 104
                })
                
                Checkmark:AddToTheme({ImageColor3 = "Accent"})
                
                local toggleValue = item.Default or false
                ...
                ToggleButton.MouseButton1Click:Connect(function()
                    ...
                    Instances:Tween(Checkmark, {ImageTransparency = toggleValue and 0 or 1}, 0.1)
                    if item.Callback then item.Callback(toggleValue) end
                end)
                
                contentHeight = contentHeight + 18 + 4
            ...
            elseif item.Type == "Keybind" then
                ...
                KeybindFrame:AddToTheme({BackgroundColor3 = "Inline", BorderColor3 = "Border"})
                
                Instances:Create("UICorner", {Parent = KeybindFrame, CornerRadius = UDimNew(0, 3)})
                ...
                KeybindLabel:TextBorder()
                
                local KeybindButton = Instances:Create("TextButton", {
                    Parent = KeybindFrame,
                    Size = UDim2New(0, 42, 0, 14),
                    Position = UDim2New(1, -46, 0.5, -7),
                    BackgroundColor3 = Library.Theme["Page Background"],
                    BorderColor3 = Library.Theme["Outline"],
                    BorderSizePixel = 1,
                    Text = item.Default or "None",
                    TextColor3 = Library.Theme["Text"],
                    TextSize = 8,
                    FontFace = Library.Font,
                    AutoButtonColor = false,
                ...
                KeybindButton:AddToTheme({BackgroundColor3 = "Page Background", BorderColor3 = "Outline", TextColor3 = "Text"})
                
                Instances:Create("UICorner", {Parent = KeybindButton, CornerRadius = UDimNew(0, 2)})
                
                local listening = false
                local currentKey = item.Default or "None"
                ...
                KeybindButton.MouseButton1Click:Connect(function()
                    ...
                    connection = UserInputService.InputBegan:Connect(function(input, gameProcessed)
                        if input.UserInputType == Enum.UserInputType.Keyboard then
                            ...
                            if item.Callback then item.Callback(key) end
                        end
                    end)
                end)
            ...
            elseif item.Type == "Slider" then
                ...
                SliderFrame:AddToTheme({BackgroundColor3 = "Inline", BorderColor3 = "Border"})
                
                Instances:Create("UICorner", {Parent = SliderFrame, CornerRadius = UDimNew(0, 3)})
                
                local SliderLabel = Instances:Create("TextLabel", {
                    Parent = SliderFrame,
                    Size = UDim2New(1, -40, 0, 14),
                    Position = UDim2New(0, 4, 0, 2),
                    BackgroundTransparency = 1,
                    Text = item.Name or "Slider",
                    TextColor3 = Library.Theme["Text"],
                    TextSize = 9,
                    FontFace = Library.Font,
                    TextXAlignment = Enum.TextXAlignment.Left,
                ...
                SliderLabel:TextBorder()
                
                local ValueLabel = Instances:Create("TextLabel", {
                    Parent = SliderFrame,
                    Size = UDim2New(0, 36, 0, 14),
                    Position = UDim2New(1, -40, 0, 2),
                    BackgroundTransparency = 1,
                    Text = tostring(item.Default or item.Min or 0),
                    TextColor3 = Library.Theme["Text"],
                    TextSize = 9,
                    FontFace = Library.Font,
                ...
                ValueLabel:TextBorder()
                
                local SliderBar = Instances:Create("Frame", {
                    Parent = SliderFrame,
                    Size = UDim2New(1, -8, 0, 4),
                    Position = UDim2New(0, 4, 1, -8),
                    BackgroundColor3 = Library.Theme["Page Background"],
                    BorderColor3 = Library.Theme["Outline"],
                    BorderSizePixel = 1,
                    ZIndex = 103
                ...
                SliderBar:AddToTheme({BackgroundColor3 = "Page Background", BorderColor3 = "Outline"})
                
                Instances:Create("UICorner", {Parent = SliderBar, CornerRadius = UDimNew(0, 2)})
                ...
                Instances:Create("UICorner", {Parent = SliderFill, CornerRadius = UDimNew(0, 2)})
                
                local min = item.Min or 0
                local max = item.Max or 100
                local default = item.Default or min
                local decimals = item.Decimals or 1
                
                local function Round(num)
                    return MathFloor(num / decimals + 0.5) * decimals
                end
                ...
                local function UpdateSlider(value)
                    ...
                    Instances:Tween(SliderFill, {Size = UDim2New(percent, 0, 1, 0)}, 0.1)
                ...
                contentHeight = contentHeight + 32 + 4
                
            elseif item.Type == "Info" then
                local InfoFrame = Instances:Create("Frame", {
                    Parent = ContentFrame,
                    Size = UDim2New(1, 0, 0, 0),
                    BackgroundColor3 = Library.Theme["Page Background"],
                    BorderColor3 = Library.Theme["Border"],
                ...
                InfoFrame:AddToTheme({BackgroundColor3 = "Page Background", BorderColor3 = "Border"})
                
                Instances:Create("UICorner", {Parent = InfoFrame, CornerRadius = UDimNew(0, 3)})
                ...
                InfoLabel:AddToTheme({TextColor3 = "Text"})
                InfoLabel:TextBorder()
                ...
                task.wait()
                contentHeight = contentHeight + InfoFrame.AbsoluteSize.Y + 4
            end
        end
        
        MenuFrame.Size = UDim2New(0, 220, 0, contentHeight)
        
        -- Posicionar el menú
        local function UpdatePosition()
            if originButton and originButton.Parent then
                local buttonPos = originButton.AbsolutePosition
                local buttonSize = originButton.AbsoluteSize
                local x = buttonPos.X + buttonSize.X + 5
                local y = buttonPos.Y
                
                if x + 220 > Camera.ViewportSize.X then
                    x = buttonPos.X - 225
                end
                
                if y + contentHeight > Camera.ViewportSize.Y then
                    y = Camera.ViewportSize.Y - contentHeight - 5
                end
                
                MenuFrame.Position = UDim2New(0, x, 0, y)
            end
        end
        
        return MenuFrame, UpdatePosition
    end
    
    -- Función para agregar settings menu a un elemento
    Library.AddSettingsMenuToElement = function(element, config)
        if not element or not element.Instance then return end
        
        local items = config.Items or {}
        if #items == 0 then return end
        
        local settingsIcon = CreateSettingsIcon(element.Instance)
        local settingsMenu, updatePosition = CreateSettingsMenu(items, settingsIcon)
        
        TableInsert(Library.SettingsMenus, {
            Element = element,
            Icon = settingsIcon,
            Menu = settingsMenu
        })
        ...
        settingsIcon.MouseButton1Click:Connect(function()
            if Library.CurrentOpenSettingsMenu and Library.CurrentOpenSettingsMenu ~= settingsMenu then
                Library.CurrentOpenSettingsMenu.Visible = false
                Instances:Tween(Library.CurrentOpenSettingsMenu, {Size = UDim2New(0, 220, 0, 0)}, 0.15)
            end
            ...
            if isOpen then
                ...
                local targetSize = settingsMenu.Size
                settingsMenu.Size = UDim2New(0, 220, 0, 0)
                Instances:Tween(settingsMenu, {Size = targetSize}, 0.2)
                Library.CurrentOpenSettingsMenu = settingsMenu
            else
                Instances:Tween(settingsMenu, {Size = UDim2New(0, 220, 0, 0)}, 0.15).Completed:Connect(function()
        ...
        UserInputService.InputBegan:Connect(function(input)
            if input.UserInputType == Enum.UserInputType.MouseButton1 and isOpen and settingsMenu.Visible then
                local mousePos = UserInputService:GetMouseLocation()
                local menuPos = settingsMenu.AbsolutePosition
                local menuSize = settingsMenu.AbsoluteSize
                local iconPos = settingsIcon.AbsolutePosition
                local iconSize = settingsIcon.AbsoluteSize
                ...
                local outsideIcon = mousePos.X < iconPos.X or mousePos.X > iconPos.X + iconSize.X or
                                   mousePos.Y < iconPos.Y or mousePos.Y > iconPos.Y + iconSize.Y
                
                if outsideMenu and outsideIcon then
                    isOpen = false
                    Instances:Tween(settingsMenu, {Size = UDim2New(0, 220, 0, 0)}, 0.15).Completed:Connect(function()
                        settingsMenu.Visible = false
                    end)
        ...
        RunService.RenderStepped:Connect(function()
            if isOpen and settingsMenu.Visible then
                updatePosition()
            end
        end)
